 ...
 * using the backward euler (BE) approximation technique
 * The BE method needs us to solve for x(n+1) by finding the root
...
int main (void) {
  ...
  FILE *fPlot;
  fPlot = fopen ("backwardEuler.dat", "w");
  fprintf (fPlot, "#     t        x  \n");
